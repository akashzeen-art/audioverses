...
export default function PolishSection({ onClick }: PolishSectionProps) {
  const totalHours = polishAudio
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3 sm:mb-4 flex-wrap gap-2">
        <h3 className="text-lg sm:text-xl font-bold text-[#EAEAEA]">Polish Audio</h3>
        <div className="bg-[#FFD369] text-[#1E1E2F] px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium">
          {polishAudio.length} titles
        </div>
      </div>
      <p className="text-[#EAEAEA]/70 text-xs sm:text-sm mb-3 sm:mb-4 leading-relaxed">
        Discover Polish literary masterpieces and cultural heritage through our Polish audio verse collection
      </p>
